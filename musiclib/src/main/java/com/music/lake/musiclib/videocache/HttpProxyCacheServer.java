package com.music.lake.musiclib.videocache;

import android.content.Context;
import android.net.Uri;

import com.music.lake.musiclib.videocache.file.DiskUsage;
import com.music.lake.musiclib.videocache.file.FileNameGenerator;
import com.music.lake.musiclib.videocache.file.Md5FileNameGenerator;
import com.music.lake.musiclib.videocache.file.TotalCountLruDiskUsage;
import com.music.lake.musiclib.videocache.file.TotalSizeLruDiskUsage;
import com.music.lake.musiclib.videocache.headers.EmptyHeadersInjector;
import com.music.lake.musiclib.videocache.headers.HeaderInjector;
import com.music.lake.musiclib.videocache.sourcestorage.SourceInfoStorage;
import com.music.lake.musiclib.videocache.sourcestorage.SourceInfoStorageFactory;
...
import static com.music.lake.musiclib.videocache.Preconditions.checkAllNotNull;
import static com.music.lake.musiclib.videocache.Preconditions.checkNotNull;
...
//    private static final Logger LOG = LoggerFactory.getLogger("HttpProxyCacheServer");
    ...
    private HttpProxyCacheServer(Config config) {
        ...
        try {
            ...
            Logger.i("Proxy cache server started. Is it alive? " + isAlive());
    ...
    public void registerCacheListener(CacheListener cacheListener, String url) {
        ...
        synchronized (clientsLock) {
            try {
                ...
                Logger.w("Error registering cache listener", e);
            }
        }
    }
    ...
    public void shutdown() {
        Logger.i("Shutdown proxy server");
    ...
    private void touchFileSafely(File cacheFile) {
        try {
            ...
            Logger.e("Error touching file " + cacheFile, e);
        }
    }
    ...
    private void waitForRequest() {
        try {
            while (!Thread.currentThread().isInterrupted()) {
                ...
                Logger.d("Accept new socket " + socket);
    ...
    private void processSocket(Socket socket) {
        try {
            ...
            Logger.d("Request to cache proxy:" + request);
            ...
            Logger.d("Opened connections: " + getClientsCount());
        }
    }
    ...
    private void closeSocketOutput(Socket socket) {
        try {
            ...
            Logger.w("Failed to close socket on proxy side: {}. It seems client have already closed connection.", e.getMessage());
        }
    }
    ...
    private void onError(Throwable e) {
        Logger.e("HttpProxyCacheServer error", e);
    }
