package com.music.lake.musiclib.videocache.file;
        ...
        for (File file : files) {
            ...
            if (!accepted) {
                ...
                if (deleted) {
                    totalCount--;
                    totalSize -= fileSize;
                    Logger.i("Cache file " + file + " is deleted because it exceeds cache limit");
                } else {
                    Logger.e("Error deleting file " + file + " for trimming cache");
                }
            }
        }
    }
